...
const MainList = (props) => {
  ...
  const scorePlus = async (id) => {
    try {
      ...
      const ab = response.data.data.things[0];
      let a = ab.score_plus;
      let b = ab.score_minus;
  ...
  return (
    ...
    //                 }}
    //               >
    //                 <span onClick={() => routeChange(thing.id)}>{thing.name}</span>
    //                 <span onClick={() => scorePlus(thing.id)}>
    //                   <svg
    //                     width="1em"
    //                     height="1em"
    //                     viewBox="0 0 16 16"
    ...
    //                 </span>
    //                 <span>{score}</span>
    //                 <span onClick={() => scoreMinus(thing.id)}>
    //                   <svg
    //                     width="1em"
    //                     height="1em"
    //                     viewBox="0 0 16 16"
